...
export default new Vuex.Store({
  ...
  actions: {
    ...
    switch_tasks_into(context, { newCard, task, newIndex }) {
      return context.dispatch('do_action', { api_method: 'switch_tasks_into', params: { board: context.state.board, newCard: newCard, task: task, newIndex: newIndex }, sync_counter: true })
    },
